...
Bhat et al. \cite{16} propose feedback-based congestion control for airtime fairness but focus on rate adaptation rather than admission decisions. Rehman et al. \cite{15} enhance spectrum access with heuristic back-off mechanisms for OFDMA, operating at frame timescales rather than flow timescales.
...
\textit{Rationale for PER}: We select Packet Error Rate (PER) as the primary network health metric rather than Channel Clean Assessment (CCA) busy ratio or Signal-to-Noise Ratio (SNR). In dense OFDMA environments, CCA often underestimates congestion due to efficient spatial reuse colors and OBSS\_PD mechanisms \cite{10}. Conversely, SNR captures link quality but fails to account for collision-induced losses in saturated contention periods. PER provides a direct, end-to-end measure of effective goodput degradation, capturing both collision effects and channel noise, making it the most reliable indicator for admission control decisions.
...
\subsection{Condensed Performance Analysis}

Our results consistently demonstrate that airtime-based CAC is essential for meeting sub-2ms latency targets. As shown in Fig. \ref{fig:comprehensive}, Soft CAC balances efficiency and QoS, achieving 15.5\% higher throughput than static Hard CAC by utilizing spare capacity for best-effort traffic. The adaptive AS-CAC+ further refines this, pushing utilization to 97.4\%—a 19.2\% gain over Hard CAC—with only a negligible 0.1 ms increase in delay. This confirms that priority-aware, adaptive thresholds can safely operate near saturation limits, unlike rigid traditional schemes.

\subsection{Complexity and Scalability Analysis}

A key advantage of AS-CAC+ is its low computational complexity. The decision logic (Algorithm \ref{alg:ascac_plus}) executes in $O(1)$ time per admission request, involving only simple arithmetic comparisons against the current aggregate airtime $A$. In contrast, machine learning-based approaches like DDPG \cite{18} significantly increase computational overhead, often requiring $O(N \cdot M)$ matrix operations for inference, where $N$ is the number of inputs and $M$ is the hidden layer size. Furthermore, DDPG requires continuous training or retraining to adapt to new environments. AS-CAC+ relies purely on instantaneous measurements (PER, Airtime) widely available in standard Wi-Fi chipsets, making it highly scalable for commodity AP hardware with limited processing power.
...
\bibitem{1} A. Bardou, T. Begin, and A. Busson, ``Improving the Spatial Reuse in IEEE 802.11ax WLANs: A Multi-Armed Bandit Approach,'' \textit{Proc. 24th ACM MSWiM}, 2021, pp. 135–144, doi: 10.1145/3479239.3485715.

\bibitem{2} B. Bellalta, ``IEEE 802.11ax: High-Efficiency WLANs,'' \textit{IEEE Wireless Commun.}, vol. 23, no. 1, pp. 38-46, Feb. 2016, doi: 10.1109/MWC.2016.7422404.

\bibitem{3} G. Bianchi, ``Performance analysis of the IEEE 802.11 distributed coordination function,'' \textit{IEEE J. Sel. Areas Commun.}, vol. 18, no. 3, pp. 535-547, Mar. 2000, doi: 10.1109/49.840210.

\bibitem{4} S. Dogan-Tusha, M. I. Rochman, A. Tusha, H. Nasiri, J. Helzerman, and M. Ghosh, ``Evaluating the Interference Potential in 6 GHz,'' \textit{Proc. ACM MobiCom WiNTECH}, 2023, pp. 56–63, doi: 10.1145/3615453.361651.

\bibitem{5} A. García-Rodríguez, D. López-Pérez, L. Galati-Giordano, and G. Geraci, ``IEEE 802.11be: Wi-Fi 7 Strikes Back,'' \textit{IEEE Commun. Mag.}, vol. 59, no. 4, 2021, pp. 102–108, doi: 10.1109/MCOM.001.2000711.

\bibitem{6} IEEE, \textit{IEEE Std 802.11ax-2021}, 2021. [Online]. Available: https://standards.ieee.org/ieee/802.11ax/7180/ [Accessed: Sep. 5, 2025].

\bibitem{7} D. D. Agbeve, A. Belogaev, and J. Famaey, ``Design and Evaluation of IEEE 802.11ax Uplink Orthogonal Multiple Access,'' \textit{ICNS3 '25: Proc. 2025 Int. Conf. on ns-3}, 2025. [Online]. Available: https://arxiv.org/abs/2506.22260.

\bibitem{8} J. S. Kaufman, ``Blocking in a Shared Resource Environment,'' \textit{IEEE Trans. Commun.}, vol. 29, no. 10, pp. 1474-1481, Oct. 1981, doi: 10.1109/TCOM.1981.1094894.

\bibitem{9} M. Knitter and R. Kays, ``Spatial Reuse Insights for IEEE 802.11ax and IEEE 802.11be Wireless LANs and Beyond,'' \textit{Proc. IEEE PIMRC}, 2022, pp. 919-925, doi: 10.1109/PIMRC54779.2022.9978080.

\bibitem{10} L. Lanante and S. Roy, ``Performance Analysis of the IEEE 802.11ax OBSS\_PD-Based Spatial Reuse,'' \textit{IEEE/ACM Trans. Netw.}, vol. 30, no. 2, pp. 616-628, Apr. 2022, doi: 10.1109/TNET.2021.3117816.

\bibitem{11} P. Liu, Y. Li, and D. Zhang, ``Performance optimization of IEEE 802.11ax UL OFDMA random access,'' \textit{J. Commun. Netw.}, vol. 26, no. 6, pp. 580-592, Dec. 2024, doi: 10.23919/JCN.2024.000069.

\bibitem{12} MediaTek, ``Wi-Fi 6/6E: Anti-Interference Technologies,'' White Paper, 2025. [Online]. Available: https://www.mediatek.com/hubfs/MediaTek\%20Assets/Pdfs/Wi-Fi\%20Anti-Interference\%20-Whitepaper.pdf [Accessed: Sep. 6, 2025].

\bibitem{13} E. Mozaffariahrar, F. Theoleyre, and M. Menth, ``A Survey of Wi-Fi 6: Technologies, Advances, and Challenges,'' \textit{Future Internet}, vol. 14, no. 10, 2022, art. 293, doi: 10.3390/fi14100293.

\bibitem{14} ns-3 Consortium, ``The ns-3 Network Simulator.'' [Online]. Available: https://www.nsnam.org/

\bibitem{15} A. Rehman, F. B. Hussain, R. Ali, H. J. Hadi, and N. Ahmad, ``Enhancing Wi-Fi 6 Spectrum Access Control with a Heuristic OFDMA Back-off Mechanism,'' \textit{Results Eng.}, vol. 26, 2025, art. 105086, doi: 10.1016/j.rineng.2025.105086.

\bibitem{16} R. V. Bhat, J. Haxhibeqiri, I. Moerman, and J. Hoebeke, ``Feedback-Based Control Loop Congestion Control Algorithm for Wireless Networks,'' \textit{IEEE Access}, vol. 12, pp. 101767-101781, 2024, doi: 10.1109/ACCESS.2024.3431577.

\bibitem{17} F. Wilhelmi, S. Barrachina-Muñoz, C. Cano, I. Selinis, and B. Bellalta, ``Spatial Reuse in IEEE 802.11ax WLANs,'' \textit{Comput. Commun.}, vol. 170, 2021, pp. 65–83, doi: 10.1016/j.comcom.2021.01.028.

\bibitem{18} H. Zhang, R. He, X. Fang, and L. Zhou, ``DDPG-based Multi-AP Cooperative Access Control in Dense Wi-Fi Networks,'' \textit{Proc. IEEE VTC-Fall}, 2023, pp. 1-6, doi: 10.1109/VTC2023-Fall60731.2023.10333712.

\bibitem{19} ZTE Corporation, ``Wi-Fi Multi-AP Home Network Technology,'' White Paper, 2024. [Online]. Available: https://www.zte.com.cn/global/about/magazine/zte-technologies/2024/6-en/expert-view-/1.html [Accessed: Sep. 5, 2025].
