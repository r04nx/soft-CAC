...
\institute[SPIT]{
  \inst{1} Dept. of Computer Science and Engg.\\
  \inst{2} Dept. of Electronics \& Telecommunication Engg.\\[-0.2em]
...
{
\setplainbg
\setbeamertemplate{footline}{} % Remove page number/footer for this slide
\begin{frame}
  \vspace{1.1cm}
  \begin{columns}
    ...
    \column{0.15\textwidth}
      % Empty space for background graphic
  \end{columns}
\end{frame}
}
