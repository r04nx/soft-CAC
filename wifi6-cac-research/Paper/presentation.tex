...
% Define a command to switch to the "Content" background (bgnew.jpeg)
...
% Define a command to switch to the "Plain" background (no-header.png)
...
\author[D. Ambawade]{Dayanand Ambawade}
\institute[SPIT]{
