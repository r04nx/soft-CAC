...
\metroset{background=light} % Optional: 'dark' or 'light' background.
\metroset{block=fill}
...
\includegraphics[width=\paperwidth,height=\paperheight]{background_content.png}%
}
...
\author[D. Ambawade, R. Pawar]{Dayanand Ambawade \and Rohan Pawar}
\institute[SPIT]{
...
% Configuration for Section Slides (Centered content)
% These should use the FULL background (with header)
\AtBeginSection[]{
  {
    \usebackgroundtemplate{\includegraphics[width=\paperwidth,height=\paperheight]{background.png}}
    \begin{frame}
      \centering
      \huge\textbf{\textcolor{spitred}{\insertsectionhead}}
    \end{frame}
  }
}
...
\begin{frame}{Comprehensive Analysis}
  \begin{figure}
    \centering
    \includegraphics[width=\linewidth,height=0.75\textheight,keepaspectratio]{../results/graphs/ascac_comprehensive_4panel.png}
